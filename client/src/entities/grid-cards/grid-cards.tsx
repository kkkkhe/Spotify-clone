				...
				{data?.slice(0, elems).map(({name, images, owner: {display_name}}) => {
					return (
						<button key={name} className="bg-[#181818] rounded-[5px] self-center justify-self-center w-full">
							<div className="p-4 pb-10 h-full items-start flex-col w-full">
								...
								<div className="flex flex-col items-start justify-start">
									<h2 className="w-full text-start overflow-x-hidden overflow-ellipsis whitespace-nowrap mb-2">{name}</h2>
